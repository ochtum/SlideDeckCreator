...
- v3では短いcue・任意の発話例・明示した見る時間を認める。ノートは画面と合わせてそのページの主張を伝える。別ページの内容、一般論、空の相づちだけではない。
- 表、コード、設定、図、フローが画面にある場合、口頭補足が必要なら具体的な読み方、判断、注意点を残す。画面で分かる場合は台詞を増やさず、見る対象と意図を記録する。
...
- 登壇の確認は画面とノートを合わせて行い、後日閲覧の確認はスライド本文と補足ページで行う。画面で伝わる情報をノートへ複製しない。
