...
```powershell
python .codex/skills/01-lt-slide-story/scripts/validate_semantic_clarity.py --story .lt-slide-work/01-story.yaml
python .codex/skills/01-lt-slide-story/scripts/validate_semantic_clarity.py --story .lt-slide-work/01-story.yaml --blueprint .lt-slide-work/02-blueprint.yaml --html output/index.html
```
